...
<body class="p-4">
<div class="container">
    <h2 class="mb-3">Sửa booking #<?= $data['id']; ?></h2>
    ...
    <form action="?act=booking-update" method="post">
        <input type="hidden" name="id" value="<?= $data['id']; ?>">

        <div class="mb-3">
            <label class="form-label">Mã booking</label>
            <input type="text" class="form-control" value="<?= htmlspecialchars($data['booking_code']); ?>" disabled>
        </div>
        ...
        <div class="row">
            <div class="mb-3 col-md-4">
                ...
                <input type="number" name="adult" class="form-control"
                       value="<?= htmlspecialchars($data['adult']); ?>" min="1">
            </div>
            <div class="mb-3 col-md-4">
                <label class="form-label">Trẻ em</label>
                <input type="number" name="child" class="form-control"
                       value="<?= htmlspecialchars($data['child']); ?>" min="0">
            </div>
            <div class="mb-3 col-md-4">
                <label class="form-label">Tổng tiền (VNĐ)</label>
                <input type="number" name="total_price" class="form-control"
                       value="<?= htmlspecialchars($data['total_price']); ?>" min="0" step="1000">
            </div>
        </div>
